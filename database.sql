...
--
-- Host: localhost    Database: hussnainmr_book
-- ------------------------------------------------------
...
CREATE TABLE `appointments` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_user_appointments` (`user_id`),
  CONSTRAINT `appointments_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `fk_user_appointments` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
-- Dump completed on 2026-02-22  3:14:22
